...
Load in data
```{r,error=FALSE,warning=FALSE}
cf = fread('./pond_inlet_2024_era.csv')
...
png("C:/Users/klynoe/Documents/pond_inlet/figs/rf_validations.png",width = 5,height = 3,units = 'in',res = 1500)
...
save off the data
```{r,error=FALSE,warning=FALSE}
write.csv(x = cf,file = "./pond_inlet_2024_gf.csv",quote = F,row.names = F)
```
