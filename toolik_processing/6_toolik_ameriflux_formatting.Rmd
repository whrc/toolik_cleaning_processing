...
knitr::opts_knit$set(root.dir = 'C:/Users/klynoe/Documents/pond_inlet/gapfill/') #use this to set your directory
```
...
Load Data
```{r}
df = fread(input = "./data/mtk_gapfilled_clean_2024.csv")
...
SWC_1_2_1 = df$SWC_12_36_1_2_1
SWC_1_3_1 = df$SWC_12_36_1_3_1

#all soil temps deg C
TS_1_1_1 = df$TS_2_38_1_1_1
TS_1_2_1 = df$TS_2_38_1_2_1
TS_1_3_1 = df$TS_2_38_1_3_1

TS_2_1_1  = df$TS_2_38_3_1_1.c
TS_2_2_1  = df$TS_2_38_3_2_1.c
TS_2_3_1  = df$TS_2_38_3_3_1.c
TS_2_4_1  = df$TS_2_38_3_4_1.c
TS_2_5_1  = df$TS_2_38_3_5_1.c
TS_2_6_1  = df$TS_2_38_3_6_1.c
TS_2_7_1  = df$TS_2_38_3_7_1.c
TS_2_8_1  = df$TS_2_38_3_8_1.c
TS_2_9_1  = df$TS_2_38_3_9_1.c
TS_2_10_1 = df$TS_2_38_3_10_1.c
TS_2_11_1 = df$TS_2_38_3_11_1.c
TS_2_12_1 = df$TS_2_38_3_12_1.c
...
```{r}
CA_MTK = data.frame(TIMESTAMP_START,TIMESTAMP_END,
  CO2,CH4,H2O
...
siteID = "CA-MTK"
resolution = 'HH'
tsstart = CA_MTK$TIMESTAMP_START[1]
tsend   = CA_MTK$TIMESTAMP_END[nrow(CA_MTK)]

filename = paste(siteID,resolution,tsstart,tsend,sep = '_')
filename = paste("./",filename,".csv",sep = "")

write.csv(x = CA_MTK,file = filename,row.names = F,na = "-9999")
```
