...
knitr::opts_knit$set(root.dir = 'C:/Users/klynoe/Documents/toolik/') #use this to set your directory
```
...
df = fread(input = "C:/Users/klynoe/Documents/toolik/R_outputs/flux_met_c/toolik_flux_met_c_202505_202510.csv")
#df = fread(input = "C:/Users/karndt.WHRC/Documents/GitHub/pondinlet_cleaning_processing/data/toolik_Flux_Met_Clean_Aug_Nov_24.csv")
...
write.csv(x = df,file = "gapfill/met_gf_toolik_2025.csv",row.names = F)
```

Add ERA5 data
```{r}
#load in era5 data for pond inlet for continuous met data (found in Ameriflux folder in bucket)
era = fread('gapfill/ERA5_toolik.csv')
...
#reduce down to toolik size and add to final data set
```{r}
...
write.csv(x = df,file = './toolik_2025_era.csv',row.names = F,quote = F)
...
```{r}
png(filename = 'C:/Users/klynoe/Documents/toolik/figs/era5_toolik_comparisons.png',width = 6,height = 4,units = 'in',res = 1500)
