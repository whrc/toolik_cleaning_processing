...
# Overwrite the final column with merged historical data - sensor name change.
df$TS_2_38_2_2_1 <- ifelse(df$TIMESTAMP <= cutoff_date, 
                           df$TS_2_38_23_1_1, 
                           df$TS_2_38_2_2_1)
...
df$SWC_12_36_2_2_1 <- ifelse(df$TIMESTAMP <= cutoff_date, 
                           df$SWC_12_36_3_1_1, 
                           df$SWC_12_36_2_2_1)

ggplot(data = df)+
  geom_point(aes(TIMESTAMP, SWC_12_36_1_1_1*100,col='SWC 08cm'))+
  geom_point(aes(TIMESTAMP, SWC_12_36_2_1_1*100,col='SWC 18cm'))+
  geom_point(aes(TIMESTAMP, SWC_12_36_2_2_1*100,col='SWC 28cm'))+
