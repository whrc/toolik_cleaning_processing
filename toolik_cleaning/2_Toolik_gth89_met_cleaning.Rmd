...
```{r, warning=FALSE}
biomet_dates <- c('2025-05-01', '2025-12-01')
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(-25,2000),
                     expression('PAR ('*mu*mol/m^2/s*')'))+
  scale_x_datetime(limits =as.POSIXct(c( '2025-05-01', '2025-11-01'),format="%F"))
```
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/met/met_c_202505_202511.csv',row.names = F,quote = T)
