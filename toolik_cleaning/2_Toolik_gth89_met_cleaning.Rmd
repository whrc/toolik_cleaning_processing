...
df = read.csv('C:/Users/klynoe/Documents/toolik/R_outputs/toolik_met_flux_merged_aligned_2025.csv')
...
```{r, warning=FALSE}
biomet_dates <- c('2025-05-01', '2025-12-16')
...
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/met/flux_met_c_202505_202512.csv',row.names = F,quote = T)
