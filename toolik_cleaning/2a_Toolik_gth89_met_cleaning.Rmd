...
df = read.csv('C:/Users/klynoe/Documents/toolik/R_outputs/met/toolik-gth89-AllBiomet.csv')
...
#MAKE SURE THAT VARIABLES ARE NUMERIC, IF NOT RUN

df[ , names(df) != "TIMESTAMP"] <- lapply(
  df[ , names(df) != "TIMESTAMP"],
...
```{r, warning=FALSE}
biomet_dates <- c('2025-05-01', '2025-11-01')
...
```{r, warning=FALSE}
ggplot(data = df)+
  geom_point(aes(TIMESTAMP,SWOUT_6_10_1_1_1))+
...
```{r, warning=FALSE}
hist(df$SWOUT_6_10_1_1_1,breaks=100)
plot(df$TIMESTAMP,df$SWOUT_6_10_1_1_1,ylim = c(0,800));abline(h=700,col= 'red');abline(h=-1, col='red')
SWOUT_6_10_1_1_1.limits <- df$SWOUT_6_10_1_1_1
SWOUT_6_10_1_1_1.limits[df$SWOUT_6_10_1_1_1 < 0] <- 0
hist(SWOUT_6_10_1_1_1.limits,breaks=100)
plot(df$TIMESTAMP,SWOUT_6_10_1_1_1.limits)
```

# Albedo 
```{r, warning=FALSE}
albedo = df$SWOUT_6_10_1_1_1.c / df$SWIN_6_10_1_1_1.c
...
ggplot(data = df)+
  ...
  geom_point(aes(TIMESTAMP, SWC_12_36_3_1_1*100,col='SWC 3'))+
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/met/met_c_202505_202510',row.names = F,quote = T)
