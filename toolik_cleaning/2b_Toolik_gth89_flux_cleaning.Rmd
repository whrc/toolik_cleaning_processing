...
#met = fread('C:/Users/klynoe/Documents/pond_inlet/R_outputs/pondinlet_met_clean_202505.csv')
...
```{r, warning=FALSE}
flux_dates <- c("2025-05-01",'2025-08-30')
```
...
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/toolik_Flux_Met_Clean_august_25.csv',row.names = F,quote = F)
```
