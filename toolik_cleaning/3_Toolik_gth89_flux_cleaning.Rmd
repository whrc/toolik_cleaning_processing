...
#met = fread('C:/Users/klynoe/Documents/toolik/R_outputs/met/flux_met_c_202505_202512.csv')

#df = fread('C:/Users/klynoe/Documents/toolik/R_outputs/flux/toolik_fluxes_202505_202512.csv')
#df = fread("C:/Users/klynoe/Documents/toolik/eddypro_output/2025/09/eddypro_09_25_full_output_2025-10-06T120635_adv.csv", skip = 3, header = F, na.strings = c('-9999','NA','NaN','NAN','-7999'))
#h = fread("C:/Users/klynoe/Documents/toolik/eddypro_output/2025/09/eddypro_09_25_full_output_2025-10-06T120635_adv.csv",skip = 1,nrows = 0)

#names(df) = names(h)

#df$TIMESTAMP = paste(df$date, df$time)
#df$TIMESTAMP = as.POSIXct(df$TIMESTAMP, format = "%Y-%m-%d %H:%M", tz = "UTC")
#met$TIMESTAMP = as.POSIXct(met$TIMESTAMP, format = "%Y-%m-%d %H:%M", tz = "UTC")
...
```{r, warning=FALSE}
df = fread('C:/Users/klynoe/Documents/toolik/R_outputs/met/flux_met_c_202505_202512.csv')
...
```{r, warning=FALSE}
flux_dates <- c("2025-05-01",'2025-12-16')
```
...
upper_limit_ch4 <- 0.15
lower_limit_ch4 <- -0.15

# Identify points outside limits
limit_fail_ch4 <- df$ch4_flux > upper_limit_ch4 | df$ch4_flux < lower_limit_ch4
...
ggplot(data = df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2025-05-14","2025-08-20")))
```
...
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/flux_met_c/toolik_flux_c_met_c_202505_202512.csv',row.names = F,quote = F)
```
