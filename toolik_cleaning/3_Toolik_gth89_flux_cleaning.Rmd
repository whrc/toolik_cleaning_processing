...
met = fread('C:/Users/klynoe/Documents/toolik/R_outputs/met/met_c_202505_202510.csv')

df = fread('C:/Users/klynoe/Documents/toolik/R_outputs/flux/toolik_fluxes_202505_202510.csv')
...
```{r, warning=FALSE}
flux_dates <- c("2025-05-01",'2025-11-01')
```
...
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/flux_met_c/toolik_flux_met_c_202505_202510.csv',row.names = F,quote = F)
```
