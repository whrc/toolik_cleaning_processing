...
```{r, warning=FALSE}
df = fread('C:/Users/klynoe/Documents/toolik/R_outputs/met/flux_met_c_202603_04.csv')
...
```{r, warning=FALSE}
flux_dates <- c("2026-03-01",'2026-05-01')
```
...
plot(df$ts,df$ch4_flux,ylim = c(-.03,.035));abline(h=.3, col= 'red');abline(h=-.20, col='red'); abline(h=0,col= 'black')
```
...
write.csv(x = df,file = 'C:/Users/klynoe/Documents/toolik/R_outputs/flux_met_c/toolik_flux_c_met_c_202603_04.csv',row.names = F,quote = F)
```
